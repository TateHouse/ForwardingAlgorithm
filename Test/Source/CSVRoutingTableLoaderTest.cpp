...
protected:
	...
	std::vector<RouteMapping> populateRoutingTableFile(const bool hasHeaderRow);
...
std::filesystem::path CSVRoutingTableLoaderTest::createTemporaryPathWithUniqueName(const std::string& name,
																				   const std::string& extension)
{
...
std::vector<RouteMapping> CSVRoutingTableLoaderTest::populateRoutingTableFile(const bool hasHeaderRow)
{
